...
public class GoldFurnaceContainer extends AbstractFurnaceContainer {
    ...
    public GoldFurnaceContainer(int id, PlayerInventory playerInventoryIn) {
        super(Registration.GOLD_FURNACE_CONTAINER.get(), IRecipeType.SMELTING, RecipeBookCategory.FURNACE, id, playerInventoryIn);
    }
    ...
    public GoldFurnaceContainer(int id, PlayerInventory playerInventoryIn, IInventory furnaceInventoryIn, IIntArray furnaceDataIn) {
        super(Registration.GOLD_FURNACE_CONTAINER.get(), IRecipeType.SMELTING, RecipeBookCategory.FURNACE, id, playerInventoryIn, furnaceInventoryIn, furnaceDataIn);
    }
}
